...
echo '\nGetting the code...\n'
git clone --branch=$SOURCE_BRANCH https://$INPUT_PAT@github.com/$GITHUB_REPOSITORY /update
...
Rscript --no-save --no-restore -e 'protocolhelper:::update_news_release("'$SOURCE_BRANCH'")'
git add NEWS.md
