...
Beoordeel of de locatie geschikt is voor het nemen van een staal (zie 3.3 "Beperkingen tot de procedure").
...
Indien de waterloop 1 m diep is of meer, worden de deelstalen genomen op 0,5 m waterdiepte (figuur \@ref(fig:Figuur2)).
...
1.  **Kopgegevens:** labocode (vooraf ingevuld), code staalnamepunt (+ code staalnamelocatie indien verschillend van code staalnamepunt), staalnemer, datum, uur
