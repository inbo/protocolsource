...
Voor deze vegetatietypes dienen in Vlaanderen een 1000-tal random geselecteerde meetpunten opgemeten te worden en dit per meetpunt op twee verschillende schaalniveaus: enerzijds een vegetatie-opname op een vierkante vegetatieplot van 3 op 3 meter en anderzijds een cirkelvormige plot met diameter 18m waar een aantal bijkomende structuurindicatoren dienen ingeschat te worden.
De meetpunten worden en bezocht en opgemeten met een frequentie van eens om de 6 jaar en laten op die manier toe om een uitspraak te doen over het aandeel habitat dat zich in een gunstige/ongunstige toestand bevindt en de trend daarvan.
=======
...
>>>>>>> 7cdbca13cdb47a1d95c4ebffdb11ecca39045307
...
<<<<<<< HEAD
**2310 Droge heide op landduinen** Dit type heide komt voor op dezelfde types bodems als de buntgrasvegetaties maar omvatten een latere fase in de successiereeks waarbij het landduin verder gefixeerd is geraakt.
=======
