...
Neem 2 foto's per meetpunt: één overzichts foto waarbij je de plot landschappelijk kadert, en een tweede waarbij je enkel de vegetatie in de plot fotografeert (zie Fig. 4)

![Figuur 4: Voorbeeld van een foto van het proefvlak in het landschap (links) en ingezoomd op het proefvlak zelf (rechts)](C:/DATA/R/protocolsource/images/fotoproefvlak.png)
...
Via tabel \@ref(tab:beslisregels-meetpunt) kan men controleren of en voor welk type het punt wel kan opgenomen worden.

(ref:beslisregels-meetpunt) beslisregels voor vervangen van een meetpunt

```{r beslisregels-meetpunt}
beslisregels <- read_csv(
  file.path(
    path_to_protocol,
    "data",
    "beslisregels.csv"
...
beslisregels %>%
  kable(caption = "(ref:beslisregels-meetpunt)")
...
Aandeeldoelvegetatie in de 18m-plot opgeven!
...
Er worden vier leeftijdscategorieën onderscheiden, namelijk, pioniersstadium, ontwikkelingsstadium, climaxstadium en degeneratiestadium (zie Fig.5).
Scoor de aanwezigheid van elk stadium m.b.v. codes uit de beheermonitoringsschaal (bijlage 1).Afwezigheid ook aangeven!

![Figuur 5: Cyclische successiestadia in 4 fasen bij Calluna vulgaris (uit Burrows, 1990)](C:/DATA/R/protocolsource/images/Calluna_fases.png)
...
![Figuur 6: Samenvatting stappenplan](C:/DATA/R/protocolsource/images/samenvatting_Werkwijze.png)
