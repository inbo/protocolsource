...
Foto's worden altijd gemaakt, ook wanneer er geen opname zal uitgevoerd worden (zie 5.1.5).
...
Vooraleer we een meting uitvoeren, moeten we eerst controleren of de doelvegetatie effectief aanwezig is in het vegetatieproefvlak.
...
Bij het schatten blijf je echter werken alsof je op een volledige plot zou doen, je gaat m.a.w. niet herrekenen voor het aandeel dat effectief doelvegetatie bevat.
In een 3 m x 3 m plot blijft 30 cm x 30 cm dus 1%.
...
De 18 meter-structuurplot wordt bekeken voor wat betreft verbossingsgraad (relatieve bedekkingsgraad in %).
...
Maar de inschatting gebeurt wel volgens dezelfde verdeling m.a.w. 10 m² blijft 1% ook al ben je bv.
