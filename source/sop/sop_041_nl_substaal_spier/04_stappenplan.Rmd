...
6.  Elk specimen (specimen ID) zit op de positie in de bewaardoos, zoals het aangegeven in het ingevulde sjabloon (zie voorbeeld bijlage 4).
...
## Voorbereiden van de snijhandelingen

Ter info: 5.3 Voorbereiden van de snijhandelingen, 5.4 Monstervoorbehandeling, 5.5 Nemen van de substaal en 5.6 Concluderen van de werksessie, dienen opeenvolgend (dezelfde werkdag) te worden uitgevoerd.
