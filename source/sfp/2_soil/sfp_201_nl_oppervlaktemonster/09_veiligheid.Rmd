...
-   Wees voorzichtig tijdens onweer in het open veld.
    Je draagt immers een metalen staaf met je mee wat de bliksem kan aantrekken.

-   Stoot je op een ondoordringbare laag of een grote steen of boomwortel, forceer de boor dan niet want je zou het materiaal kunnen beschadigen.
    Steek beter opnieuw op een andere plaats (bvb. in geval van een stenige bodem).

-   In het geval dat je een hamer moet gebruiken op een guts met een slagkop, gebruik steeds een terugslagvrije hamer (Figuur \@ref(fig:gutsboren)).
