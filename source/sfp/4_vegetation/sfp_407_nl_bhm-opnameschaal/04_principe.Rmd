...
De hoofdcodes van de beheermonitoringschaal zien er als volgt uit:
...
Bij de beheermonitoringschaal worden zowel de relatieve abundantie als de bedekking van soorten betrokken ter begrenzing van de verschillende categorieën om zo een enigszins eenduidige interpretatie van een code mogelijk te maken en daarmee de vergelijkbaarheid van de gegevens te verhogen.Indien een soort minstens 5% bedekt, worden enkel de codes vanaf B gebruikt (ook al gaat het maar om 1 of enkele individuen).
