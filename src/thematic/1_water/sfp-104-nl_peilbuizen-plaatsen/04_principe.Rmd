...
-->
```
Een blinde buis met een geperforeerd deel (de filter) wordt in de grond geplaatst (figuur 1).
...
In deze situaties mag er dan ook [**geen lijm**]{.ul} gebruikt worden en dient men klemmoffen te gebruiken (zie §5.2).
...
in een zandige of grindige ondergrond wordt er gebruik gemaakt van een verbuizing (foto 1, F).
...
Als alternatief kan dan een pulsboor een uitweg bieden (foto 1, E).
...
![(#fig:Figuur2) afwerking piëzometers met metalen beschermbuis en hangslot (A) en ondergronds afgewerkt met straatpot (B).](.%5Cmedia/image3.jpg){width="4.223958880139983in" height="3.5081528871391074in"}
...
Bovengronds kunnen buizen beschermd worden door er een **metalen beschermbuis** met een minimale lengte van 1 meter overheen te plaatsen (Figuur \@ref(fig:Figuur1), ).
...
Als er vandalisme verwacht wordt of als de buis in het midden van een hooi- of een weiland staat, kan je de buis ook ondergronds **afwerken met een straatpot** (figuur 1, B).
...
Elk meetpunt krijgt onmiddellijk een eenduidige identificatie (zie §6.2) op de buis met een permanente marker.
